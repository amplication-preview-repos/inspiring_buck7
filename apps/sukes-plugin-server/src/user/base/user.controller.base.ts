...
import { AppModelFindManyArgs } from "../../appModel/base/AppModelFindManyArgs";
...
export class UserControllerBase {
  ...
  async findApps(
    ...
    const query = plainToClass(AppModelFindManyArgs, request.query);
  ...
  async connectApps(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: AppModelWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      apps: {
        connect: body,
